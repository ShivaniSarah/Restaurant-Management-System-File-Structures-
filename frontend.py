...
def new_winF1(): # new window definition
    ...
    l3=Label(newwin,text="Buying_date(yyyy-mm-dd)",bg='#59253A',fg='white')
    ...
    l4=Label(newwin,text="Expiry_date(yyyy-mm-dd)",bg='#59253A',fg='white')
...
def new_winF2(): # new window definition
    ...
    l1.grid(row=0,column=3,padx=(50,0))
    ...
    l1.grid(row=0,column=9,padx=(50,0))

    l1=Label(newwin,text="SHOPS",bg='#05386B',fg='white')
    l1.grid(row=3,column=9,padx=(50,0))
    ...
    list1=Listbox(newwin, height=75,width=50)
    list1.grid(row=1,column=0,rowspan=5,columnspan=2)
    sb1=Scrollbar(newwin)
    sb1.grid(row=1,column=2,rowspan=5)
    list1.configure(yscrollcommand=sb1.set)
    sb1.configure(command=list1.yview)

    list2=Listbox(newwin, height=75,width=50)
    list2.grid(row=1,column=3,rowspan=4,columnspan=2)
    sb2=Scrollbar(newwin)
    sb2.grid(row=1,column=5,rowspan=5)
    list2.configure(yscrollcommand=sb2.set)
    sb2.configure(command=list2.yview)

    list3=Listbox(newwin, height=75,width=40)
    list3.grid(row=1,column=6,rowspan=5,columnspan=2)
    sb3=Scrollbar(newwin)
    sb3.grid(row=1,column=8,rowspan=5)
    list3.configure(yscrollcommand=sb3.set)
    sb3.configure(command=list3.yview)

    list4=Listbox(newwin, height=35,width=40)
    list4.grid(row=1,column=9,rowspan=2,columnspan=2)
    sb4=Scrollbar(newwin)
    sb4.grid(row=1,column=11,rowspan=2)
    list4.configure(yscrollcommand=sb4.set)
    sb4.configure(command=list4.yview)

    list5=Listbox(newwin, height=35,width=40)
    list5.grid(row=4,column=9,rowspan=2,columnspan=2)
    sb5=Scrollbar(newwin)
    sb5.grid(row=4,column=11,rowspan=5)
    list5.configure(yscrollcommand=sb5.set)
    sb5.configure(command=list5.yview)


    list6=Listbox(newwin, height=75,width=40)
    list6.grid(row=1,column=12,rowspan=5,columnspan=2)
    sb6=Scrollbar(newwin)
    sb6.grid(row=1,column=14,rowspan=5)
    list6.configure(yscrollcommand=sb6.set)
...
def new_winF3(): # new window definition
    ...
    l1=Label(newwin,text="From date(yyyy-mm-dd)",bg='#C96567')
    l1.grid(row=0,column=0,pady=(200,20),padx=(750,2))
    l2=Label(newwin,text="To date(yyyy-mm-dd)",bg='#C96567')
...
C=Canvas(window,bg="blue",height=500,width=500) 

background_image=PhotoImage(file="food.png")
background_label = Label(window,image=background_image,height=100,width=100)
...
l3=Label(window,text="No of people(for stock)",bg='#05386B',fg='white')
